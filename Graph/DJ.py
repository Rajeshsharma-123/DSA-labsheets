...
def compute_shortest_path(G, start):
    ...
    while(len(visited)< len(G)):
        ...
        # print("For Current vertex", currentVertex)
        for chimeki in G[currentVertex]:
            if chimeki not in visited:
            #    print("This is chimeki", chimeki)
...
# task for next lab
# Implement krushkals and prims algorith for computing minimum spanning tree in python 